...
Usage:
    ...
    python -m cosmos_framework.model.vfm.vlm.qwen3_vl_moe.moe_bench

    # Forward + backward:
    python -m cosmos_framework.model.vfm.vlm.qwen3_vl_moe.moe_bench --backward

    # Compare grouped_mm vs naive:
    python -m cosmos_framework.model.vfm.vlm.qwen3_vl_moe.moe_bench --compare

    # Disable torch.compile:
    python -m cosmos_framework.model.vfm.vlm.qwen3_vl_moe.moe_bench --no-compile
    ...
    python -m cosmos_framework.model.vfm.vlm.qwen3_vl_moe.moe_bench --profile

    # Profile to a custom directory:
    python -m cosmos_framework.model.vfm.vlm.qwen3_vl_moe.moe_bench --profile --profile-dir ./my_traces

    # All options:
    python -m cosmos_framework.model.vfm.vlm.qwen3_vl_moe.moe_bench --help
"""
