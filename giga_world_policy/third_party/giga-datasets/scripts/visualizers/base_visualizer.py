...
def get_args():
    ...
    parser.add_argument('--data_path', type=str, required=True, help='Directory to load giga data')
    parser.add_argument('--save_path', type=str, required=True, help='Directory to save visualization results')
