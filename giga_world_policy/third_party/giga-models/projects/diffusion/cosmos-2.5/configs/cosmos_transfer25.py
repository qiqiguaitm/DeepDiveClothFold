config = dict(
    ...
    project_dir='./experiments/cosmos2_5/edge',
    launch=dict(
    ...
    models=dict(
        ...
        transformer_model_path='/path/to/cosmos2_5/models--nvidia--Cosmos-Transfer2.5-2B/general/transformer',
        controlnet_model_path='/path/to/cosmos2_5/models--nvidia--Cosmos-Transfer2.5-2B/general/controlnet/edge',
    ),
    optimizers=dict(
        type='AdamW',
        lr=1e-6,
