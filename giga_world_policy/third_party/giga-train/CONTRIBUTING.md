# How to contribute to GigaTrain?

[![Contributor Covenant](https://img.shields.io/badge/Contributor%20Covenant-2.0-4baaaa.svg)](CODE_OF_CONDUCT.md)

GigaTrain is an open source project, so all contributions and suggestions are welcome.
...
You have the list of open Issues at [here](https://github.com/open-gigaai/giga-train/issues).
...
1. Fork the [repository](https://github.com/open-gigaai/giga-train) by clicking on the 'Fork' button on the repository's page. This creates a copy of the code under your GitHub user account.
...
2. Clone your fork to your local disk, and add the base repository as a remote:
   ...
   ```shell
   cd giga-train
   git remote add upstream https://github.com/open-gigaai/giga-train.git
   ```
