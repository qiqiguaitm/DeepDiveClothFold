...
def mkp_dt(s, dt):  # state ⊕ Δstate(隔 dt 帧, 对齐时间语义)
...
for k, EP in enumerate(TEST):
    aa3, rr3, st3, n3 = loadnpz(FC, EP); em3, d3 = emission(aa3, rr3, st3, 1)
...
fig.tight_layout(); out = REPO / "docs/visualization/cross_episode_recurrence_value/crave_30hz_test.png"
