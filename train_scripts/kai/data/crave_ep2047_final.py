...
src = open("train_scripts/kai/data/crave_30hz_test.py").read().split("fig, axs")[0]
...
fig.tight_layout(); out = REPO / "docs/visualization/cross_episode_recurrence_value/crave_ep2047_final_offline_vs_online.png"
