...
对比 cond_end ON/OFF。 跑法: kai0/.venv/bin/python train_scripts/kai/data/crave_truncate_test.py
"""
import sys, json
...
REPO = Path("/vePFS/tim/workspace/deepdive_kai0"); DS = REPO / "kai0/data/Task_A/kai0_base"
